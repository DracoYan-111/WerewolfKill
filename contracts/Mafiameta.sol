...
contract Mafiameta is IERC20, Ownable {
    ...
    uint256 public _inviterSonFee = 10;
    ...
    address private _fundAddress =
        address(0xE3F3E44C02c9fFAF482f2Dd4E0069cd3cf02338D);
    ...
    address private _pledgeAddress =
        address(0x761101b50A4221e04814e77580527D48AEb9cA4a);

    address public _communityGovernanceAddress =
        address(0x5b68cdb07c3701ba2172587cE1408C3D33cE66c0);

    // Joint sermon address
    address private _sermonAddress =
        address(0x4B69a0413B90B762E7Afc63f044f90eFe29a9BB9);
